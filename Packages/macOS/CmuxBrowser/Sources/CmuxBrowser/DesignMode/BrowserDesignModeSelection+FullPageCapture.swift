...
extension BrowserDesignModeSelection {
    public var usesViewportCaptureCoordinates: Bool {
    ...
    public func documentCaptureRect(webViewBounds: NSRect) -> NSRect {
        let values = [
            bounds.x,
            bounds.y,
            bounds.width,
    ...
    public func fullPageCaptureRect(imageSize: NSSize) -> NSRect {
        let values = [
            bounds.x,
            bounds.y,
            bounds.width,
