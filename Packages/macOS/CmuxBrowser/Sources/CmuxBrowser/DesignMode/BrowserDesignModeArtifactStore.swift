...
public actor BrowserDesignModeArtifactStore {
    private static let fileLimit = 100
    @usableFromInline
    static let processLiveContextSessionID = String(UUID().uuidString.prefix(8))
    ...
    public func retainHandoffArtifacts(at paths: [String], lease: UUID) -> Bool {
    ...
    public func releaseHandoff(_ lease: UUID) {
        try? withDirectoryLock {
