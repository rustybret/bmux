...
public enum CloudTreeMachineSource: Equatable, Sendable {
    ...
    public var includesCloudMachines: Bool {
        switch self {
    ...
    public var includesDevices: Bool {
        switch self {
    ...
    public var groupsDevicesUnderSection: Bool { self == .cloudWithDevicesSection }
}
