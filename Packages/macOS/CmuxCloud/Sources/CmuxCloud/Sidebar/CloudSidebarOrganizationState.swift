...
public struct CloudSidebarOrganizationState: Codable, Equatable, Sendable {
    public init(
        groups: [String: CloudSidebarOrganizationGroup] = [:]
    ) {
        self.groups = groups
    }

    public var groups: [String: CloudSidebarOrganizationGroup] = [:]

    public func ordered(_ ids: [String], parent: String) -> [String] {
    ...
    public func isPinned(_ id: String, parent: String) -> Bool {
        groups[parent]?.pinned.contains(id) == true
    }

    public mutating func apply(_ action: CloudSidebarOrganizationAction, id: String, siblings: [String], parent: String) -> Bool {
