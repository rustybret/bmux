...
public struct CloudMachineNotificationEvent: Equatable, Sendable {
    public static let maxTitleBytes = 128
    ...
    public static let maxNotificationsPerDelta = 16
    ...
    public init(id: String, terminalID: String?, title: String, body: String) {
        self.id = id
...
public enum CloudMachineStreamItem: Equatable, Sendable {
...
extension CloudMachineNotificationEvent {
    public static func parse(line: String) -> CloudMachineStreamItem {
    ...
    public static func parse(line: Data) -> CloudMachineStreamItem {
    ...
    public static func isPublicID(_ candidate: String, prefix: String) -> Bool {
