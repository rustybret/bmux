...
public final class BrowserViewportHostView: NSView {
    ...
    public func installWebView(_ nextWebView: WKWebView) {
    ...
    @discardableResult
    public func deactivateWebView(using nativeLayout: BrowserViewportLayout) -> Bool {
    ...
    public func apply(_ layout: BrowserViewportLayout, updateWebView: Bool = true) {
    ...
    public func matches(_ layout: BrowserViewportLayout, epsilon: CGFloat = 0.5) -> Bool {
