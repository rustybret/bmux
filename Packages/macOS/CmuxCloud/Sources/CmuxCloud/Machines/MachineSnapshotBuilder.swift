...
public enum MachineSnapshotBuilder: Sendable {
    ...
    public static func includingCatalogMachines(_ machines: [MachineSnapshot], catalog: SurfaceCatalogSnapshot) -> [MachineSnapshot] {
    ...
    public static func freeAccessState(expiresAt: Date, now: Date = Date()) -> MachineSnapshot.FreeAccessState {
    ...
    public static func freeAccessCountdown(remaining: TimeInterval) -> String {
    ...
    public static func freeAccessBanner(
        expiresAt: Date?,
        isPaidPlan: Bool,
        now: Date = Date()
    ...
    public static func freeAccessState(
        createdAt: Date?,
        windowDays: Int,
        now: Date = Date()
    ...
    public static func nextFreeAccessTransition(
        createdAt: Date?,
        windowDays: Int,
        now: Date = Date()
    ) -> Date? {
    ...
    public static func applyingUsage(
