...
public struct CloudTunnelBackendSelector: Sendable {
    public init(
        networkExtensionCapabilities: @escaping @Sendable () -> [String],
        canInstallSystemExtensions: @escaping @Sendable () -> Bool,
        bundledExtensionIdentifier: @escaping @Sendable () -> String?
    ) {
        self.networkExtensionCapabilities = networkExtensionCapabilities
        self.canInstallSystemExtensions = canInstallSystemExtensions
        self.bundledExtensionIdentifier = bundledExtensionIdentifier
    }
    ...
    public let networkExtensionCapabilities: @Sendable () -> [String]
    /// Whether `com.apple.developer.system-extension.install` is granted.
    public let canInstallSystemExtensions: @Sendable () -> Bool
    /// `CFBundleIdentifier` of the bundled `.systemextension`, if any.
    public let bundledExtensionIdentifier: @Sendable () -> String?

    public func select() -> CloudTunnelBackend {
    ...
    public static func live(bundle: Bundle = .main) -> CloudTunnelBackendSelector {
    ...
    public static func bundledSystemExtensionIdentifier(
        in bundleURL: URL,
