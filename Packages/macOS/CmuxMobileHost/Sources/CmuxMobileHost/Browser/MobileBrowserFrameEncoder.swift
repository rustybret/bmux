...
@MainActor
public struct MobileBrowserFrameEncoder {
    public let budget: MobileBrowserFrameSizeBudget
    ...
    public nonisolated init(budget: MobileBrowserFrameSizeBudget = MobileBrowserFrameSizeBudget()) {
        self.budget = budget
    }

    public func encode(_ image: NSImage, format: MobileBrowserFrameFormat) throws -> MobileBrowserEncodedFrame {
        var candidate = image
