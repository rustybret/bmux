...
@MainActor
public final class BrowserDocumentReadyMessageHandler: NSObject, WKScriptMessageHandler {
    public static let name = "cmuxDocumentReady"
    public static let contentWorld = WKContentWorld.world(name: "cmux.browser.document-ready")
