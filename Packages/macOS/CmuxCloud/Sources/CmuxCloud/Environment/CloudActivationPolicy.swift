...
public struct CloudActivationPolicy: Sendable {
    public init(
        isCloudMachinesEnabled: @escaping @Sendable () -> Bool,
        hasUsedCloud: @escaping @Sendable () -> Bool,
        hasCloudMachine: @escaping @Sendable () -> Bool?,
        isTunnelConfigured: @escaping @Sendable () -> Bool,
        resolveCloudMachine: @escaping @Sendable () async -> Bool?
    ) {
        self.isCloudMachinesEnabled = isCloudMachinesEnabled
        self.hasUsedCloud = hasUsedCloud
        self.hasCloudMachine = hasCloudMachine
        self.isTunnelConfigured = isTunnelConfigured
    ...
    public let hasUsedCloud: @Sendable () -> Bool
    ...
    public let hasCloudMachine: @Sendable () -> Bool?
    ...
    public let isTunnelConfigured: @Sendable () -> Bool
    ...
    public var allowsLaunchTimeTunnelAdoption: Bool {
    ...
    public func tunnelStartRefusal() -> CloudTunnelStartRefusal? {
    ...
    public func resolvedTunnelStartRefusal() async -> CloudTunnelStartRefusal? {
        guard isCloudMachinesEnabled() else { return .cloudMachinesOff }
    ...
    public var tunnelAdmission: CloudTunnelAdmission {
    ...
    public static func listedFleetHasMachine() async -> Bool? {
