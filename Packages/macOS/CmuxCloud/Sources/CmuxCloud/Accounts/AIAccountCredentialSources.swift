...
public enum AIAccountProvider: String, Sendable {
    case claude
    case codex
...
public enum AIAccountCredentialSourceError: Error, CustomStringConvertible {
...
public struct AIAccountUploadPayload: Sendable, CustomDebugStringConvertible {
    ...
    public init(provider: AIAccountProvider, label: String?, credential: Credential) {
...
public struct AIAccountCredentialSources: Sendable {
    ...
    public func claudeUploadPayload(credentialsData: Data, label: String?) throws -> AIAccountUploadPayload {
    ...
    public func codexUploadPayload(authData: Data, label: String?) throws -> AIAccountUploadPayload {
    ...
    public func apiKeyUploadPayload(
        provider: AIAccountProvider,
        label: String?,
        explicitAPIKey: String?
    ) throws -> AIAccountUploadPayload {
