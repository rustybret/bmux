...
public struct BrowserAuthPromptTextFormatter {
    @usableFromInline
    static let defaultDangerousScalars: Set<Unicode.Scalar> = [
    ...
    public func filteredText(_ text: String) -> String {
    ...
    public func sanitizedText(_ text: String) -> String {
    ...
    public func middleElidedText(_ text: String) -> String {
        let trimmed = filteredText(text)
        guard trimmed.count > textMaxLength else {
            return trimmed
        }
    ...
    public func defaultPort(forProtocol protocolName: String?) -> Int? {
