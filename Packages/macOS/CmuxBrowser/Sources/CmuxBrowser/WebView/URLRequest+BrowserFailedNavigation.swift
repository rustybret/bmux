...
extension URLRequest {
    public var browserCanReloadWithURLOnly: Bool {
    ...
    public func browserMatchesFailedNavigationURLString(_ failedURL: String) -> Bool {
    ...
    public func browserMatchesReplayShape(of other: URLRequest) -> Bool {
        let method = httpMethod?.uppercased() ?? "GET"
