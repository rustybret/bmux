...
public struct CloudTunnelBanner: Equatable, Sendable {
    ...
    public var opensSystemSettings: Bool { kind == .awaitingApproval }
    ...
    public var showsInMachinesPanel: Bool { kind != .connected }

    public init?(status: CloudTunnelStatus) {
