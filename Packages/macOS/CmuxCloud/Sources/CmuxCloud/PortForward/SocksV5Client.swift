...
public enum SocksV5Client: Sendable {
    ...
    public static func connectRequest(host: String, port: Int) throws -> [UInt8] {
    ...
    public static func checkMethodSelection(_ bytes: [UInt8]) throws {
    ...
    public static func replyTrailerLength(header: [UInt8]) throws -> Int? {
    ...
    /// the two-byte port.
    public static func domainReplyTrailerLength(lengthByte: UInt8) -> Int {
        Int(lengthByte) + 2
    }

    /// Validates a complete CONNECT reply.
    public static func checkReply(_ bytes: [UInt8]) throws {
