...
public actor CloudLoopbackPortForward {
    ...
    public private(set) var target: CloudPortForwardTarget
    ...
    public init(target: CloudPortForwardTarget, dialer: any CloudHubDialing, relay: CloudPortForwardRelay? = nil) throws {
        self.target = target
    ...
    public var localURLString: String { "http://127.0.0.1:\(localPort)" }
    ...
    public func warmUpHub() async throws {
    ...
    /// changes.
    public func retarget(_ newTarget: CloudPortForwardTarget) {
        target = newTarget
