...
@MainActor
public final class CloudNotificationSyncStore {
    ...
    public static func key(machineID: String) -> String { "cloud.notifications.sync.\(machineID)" }
    ...
    public func load(machineID: String) -> CloudNotificationSyncState {
    ...
    public func save(_ state: CloudNotificationSyncState, machineID: String) {
    ...
    public var hasPendingWrites: Bool { writeTask != nil }
