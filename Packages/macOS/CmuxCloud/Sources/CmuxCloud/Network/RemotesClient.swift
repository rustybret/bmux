...
public actor RemotesClient {
    @MainActor public private(set) static var shared: RemotesClient!
    ...
    public func list() async throws -> [RemoteSummary] {
    ...
    @discardableResult
    public func add(name rawName: String, routes routeStrings: [String], tag rawTag: String?) async throws -> String {
    ...
    /// removed device UUID.
    @discardableResult
    public func remove(target rawTarget: String) async throws -> String {
    ...
    public static func deviceId(forName name: String, ownerID: String? = nil) -> String {
    ...
    public static func parseDisplayRoutes(_ raw: Any?) -> [RemoteRouteDisplay] {
