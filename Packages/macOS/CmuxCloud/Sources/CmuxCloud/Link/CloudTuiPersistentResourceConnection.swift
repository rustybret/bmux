...
public actor CloudTuiPersistentResourceConnection {
    ...
    public func request(_ request: CloudTuiRequest, timeout: Duration = .seconds(30)) async throws -> Data {
    ...
    public func events(cursor: CloudVMCursor?) async throws -> (id: String, stream: AsyncStream<Data>) {
        try await start()
