...
@MainActor
public final class CloudSidebarNotificationCoordinator {
    ...
    public init(apply: @escaping @MainActor (SurfaceMachineID, [SurfaceResourceID]) -> Void) {
        self.apply = apply
    }

    deinit { task?.cancel() }

    public func enqueue(_ resource: SurfaceResourceID) {
