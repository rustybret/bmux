...
extension CmuxTuiSnapshotParser {
    ...
    @Sendable
#endif
    public nonisolated static func terminalPlacement(from data: Data, terminalID: String) async -> (placement: SurfaceRemotePlacement?, revision: String?)? {
    ...
    @Sendable
#endif
    public nonisolated static func placedTab(
        from data: Data,
    ...
    @Sendable
#endif
    public nonisolated static func tabPlacement(from data: Data, tabID: String) async -> (workspaceID: String?, revision: String)? {
        guard let snapshot = try? JSONSerialization.jsonObject(with: data) as? [String: Any],
              authoritativeGraphIsValid(snapshot),
    ...
    public static func projectionTarget(from snapshot: [String: Any], inWorkspace workspaceID: String) -> CloudTuiTerminalProjectionTarget? {
