...
@MainActor
public final class PhonePushSerialDeliveryQueue {
    public typealias Sender = @MainActor @Sendable (
        PhonePushRequestEnvelope
    ) async -> PhonePushHTTPResult
    public typealias PendingChanged = @MainActor @Sendable (
        [PhonePushRequestEnvelope]
    ) -> Void
    ...
    @discardableResult
    public func enqueue(_ envelope: PhonePushRequestEnvelope) -> Bool {
    ...
    @discardableResult
    public func enqueuePrioritizingDismiss(_ envelope: PhonePushRequestEnvelope) -> Bool {
    ...
    public func restore(_ envelopes: [PhonePushRequestEnvelope]) {
    ...
    public func retainOnly(accountID: String, generation: UInt64? = nil) {
    ...
    public nonisolated static func normalized(
