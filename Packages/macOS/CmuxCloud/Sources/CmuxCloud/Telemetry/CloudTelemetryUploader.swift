...
public actor CloudTelemetryUploader: CloudTelemetrySending {
    ...
    public static var telemetryBaseURL: URL {
        #if DEBUG
    ...
    public func enqueue(_ original: CloudTelemetrySpan, identity: AuthenticatedSessionIdentity) async {
