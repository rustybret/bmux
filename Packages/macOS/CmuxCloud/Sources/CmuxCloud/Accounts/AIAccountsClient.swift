...
public actor AIAccountsClient {
    @MainActor public private(set) static var shared: AIAccountsClient!
    ...
    public func list(teamID: String?) async throws -> [JSONValue] {
    ...
    public func upload(_ payload: AIAccountUploadPayload, teamID: String?, validate: Bool) async throws -> JSONValue {
    ...
    public func remove(id accountID: String, teamID: String?) async throws -> JSONValue {
