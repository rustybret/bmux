...
public actor PhonePushQueueStore {
    ...
    public func load(nowEpochSeconds: Int) throws -> [PhonePushRequestEnvelope] {
    ...
    public func save(_ envelopes: [PhonePushRequestEnvelope]) throws {
        try withExclusiveStoreLock {
            let bounded = Array(
