...
public func browserShouldPromptForHTTPBasicAuth(
...
@MainActor public final class BrowserHTTPBasicAuthPromptCoordinator {
    public nonisolated init() {}

    public typealias Completion = BrowserHTTPBasicAuthPromptRequest.Completion
    typealias PromptCancellation = BrowserHTTPBasicAuthPromptRequest.PromptCancellation
    public typealias PromptCancellationRegistration = BrowserHTTPBasicAuthPromptRequest.PromptCancellationRegistration
