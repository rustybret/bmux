...
public struct BrowserErrorPageContent {
    public let title: String
    public let message: String
    public let permitsSSLBypass: Bool

    public init(title: String, message: String, permitsSSLBypass: Bool) {
        self.title = title
        self.message = message
        self.permitsSSLBypass = permitsSSLBypass
    }

    public init(error: NSError, failedURL: String) {
