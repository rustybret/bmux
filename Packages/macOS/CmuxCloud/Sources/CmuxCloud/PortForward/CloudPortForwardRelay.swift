...
public struct CloudPortForwardRelay: Sendable {
    public init(
    ...
    public let dialer: any CloudHubDialing
    ...
    public var handshakeTimeout: Duration = .seconds(15)
    ...
    public static func connect(_ upstream: NWConnection, to target: CloudPortForwardTarget) async throws {
    ...
    public static func relay(_ client: NWConnection, _ upstream: NWConnection) async {
