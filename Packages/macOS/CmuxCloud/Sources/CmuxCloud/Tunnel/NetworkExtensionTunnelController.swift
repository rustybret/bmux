...
@MainActor
public final class NetworkExtensionTunnelController: CloudTunnelControlling {
    ...
    public init(providerBundleIdentifier: String, activator: SystemExtensionActivator = SystemExtensionActivator()) {
    ...
    public nonisolated var statusUpdates: AsyncStream<CloudTunnelLinkStatus> {
    ...
    public func currentStatus() async -> CloudTunnelLinkStatus {
