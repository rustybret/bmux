...
public typealias BrowserNavigationActionDecisionHandler =
...
public typealias BrowserNavigationResponseDecisionHandler =
...
public final class BrowserNavigationDecisionHandler<Policy> {
    ...
    public var closure: (Policy) -> Void {
        { [self] policy in
            self(policy)
        }
    }
    ...
    public func callAsFunction(_ policy: Policy) {
