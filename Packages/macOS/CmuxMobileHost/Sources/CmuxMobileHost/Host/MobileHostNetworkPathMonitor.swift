...
/// change in practice.
@MainActor
public final class MobileHostNetworkPathMonitor {
    ...
    public nonisolated static func signature(
        status: String,
    ...
    public nonisolated static func systemLocalIPv4Addresses() -> [String] {
    ...
    public nonisolated static func shouldReportPathChange(
