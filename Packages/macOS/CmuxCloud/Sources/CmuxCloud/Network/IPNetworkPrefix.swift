...
public struct IPNetworkPrefix: Sendable, Equatable {
    ...
    /// entries are ignored).
    public static func host(_ host: String, isWithinAnyOf cidrs: [String]) -> Bool {
    ...
    /// has no host.
    public static func routeHost(_ route: String) -> String? {
