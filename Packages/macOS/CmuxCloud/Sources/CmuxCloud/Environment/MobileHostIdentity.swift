...
public enum MobileHostIdentity: Sendable {
    ...
    public static func deviceIDIfReady() -> String? {
    ...
    public static func baseDisplayName() -> String? {
        baseDisplayName(defaults: .standard)
    }

    public static func baseDisplayName(defaults: UserDefaults) -> String? {
        baseDisplayName(defaults: defaults, hostName: Host.current().localizedName)
    }

    public static func baseDisplayName(
        defaults: UserDefaults,
        hostName: String?
    ) -> String? {
    ...
    public static func instanceDisplayName() -> String? {
        instanceDisplayName(defaults: .standard)
    }

    public static func instanceDisplayName(defaults: UserDefaults) -> String? {
        instanceDisplayName(
            defaults: defaults,
    ...
    public static func instanceDisplayName(
        defaults: UserDefaults,
        hostName: String?,
        buildTag: String?
    ) -> String? {
    ...
    /// identity.
    public static func instanceTag() -> String {
        instanceTag(
    ...
    public static func instanceTag(
