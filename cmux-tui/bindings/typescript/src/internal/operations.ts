...
export const operations = Object.freeze({
  ...
  sessionJournalProducerList: op("session.journal.producer.list", "read"),
  sessionJournalProducerPut: op("session.journal.producer.put", "mutation"),
  sessionJournalAppend: op("session.journal.append", "mutation"),
