...
public struct CloudTreeMachineResourceRowContent: View {
    public init(
        row: CloudTreeMachineResourceRow,
    ...
    public let row: CloudTreeMachineResourceRow
    public var style: CloudTreeStyle = CloudTreeStyleStore.current
