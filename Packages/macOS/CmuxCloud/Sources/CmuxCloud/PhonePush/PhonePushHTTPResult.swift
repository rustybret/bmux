...
public enum PhonePushHTTPResult: Equatable, Sendable {
    ...
    public static func decode(statusCode: Int, data: Data) -> Self {
        switch statusCode {
        case 200...299:
    ...
    public static func classifyTransportError(_ error: any Error) -> Self {
